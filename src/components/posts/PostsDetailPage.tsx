...
export function PostsDetailPage({
  ...
  return (
    <div className="grid grid-cols-1 gap-10 lg:grid-cols-[260px_1fr_280px]">
      <ResponsiveSidebar kind="posts" entries={sidebarEntries} activeHref={entry.href} title="Posts" />
      <article className="min-w-0">
        {entry.hero ? <img src={entry.hero} alt="" className="aspect-[16/9] w-full rounded-xl object-cover" /> : null}
